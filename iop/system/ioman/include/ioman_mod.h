...
#define IOMAN_RETURN_VALUE_IMPL(val) \
	__attribute__((unused)) static inline int my_ioman_retval_##val##_int(void) {return -val;} \
	__attribute__((unused)) static inline signed long long my_ioman_retval_##val##_s64(void) {return -val;}	
